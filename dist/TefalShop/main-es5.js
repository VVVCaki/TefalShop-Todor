...
var AddBlogComponent = /** @class */ (function () {
    function AddBlogComponent(route, router, postblogService) {
        this.route = route;
        this.router = router;
    ...
    AddBlogComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            _this.blog = _this.bloglist[+params.get('blogId')];
        });
    };
    AddBlogComponent.prototype.addNewBlog = function (blog) {
...
/* harmony import */ var _sweetalert2_ngx_sweetalert2__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @sweetalert2/ngx-sweetalert2 */ "./node_modules/@sweetalert2/ngx-sweetalert2/fesm5/sweetalert2-ngx-sweetalert2.js");
...
var AutentifikacijaService = /** @class */ (function () {
    ...
    AutentifikacijaService.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var BlogComponent = /** @class */ (function () {
    function BlogComponent(postblogService, autentifikacijaService, router) {
        this.postblogService = postblogService;
        this.autentifikacijaService = autentifikacijaService;
        this.router = router;
...
var EditBlogComponent = /** @class */ (function () {
    function EditBlogComponent(route, router, postblogService) {
        this.route = route;
        this.router = router;
        this.postblogService = postblogService;
        this.bloglist = src_app_bloglist__WEBPACK_IMPORTED_MODULE_3__["bloglist"];
...
var FormaComponent = /** @class */ (function () {
    function FormaComponent() {
        this.phoneMask = ['+', '(', /[1-9]/, /\d/, /\d/, ')', ' ', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/];
    }
    FormaComponent.prototype.onSubmit = function () {
...
var GeolocationComponent = /** @class */ (function () {
    ...
    GeolocationComponent.prototype.onChoseLocation = function (event) {
...
var KorpaComponent = /** @class */ (function () {
    function KorpaComponent(shoppingservice, router) {
    ...
    KorpaComponent.prototype.isprazniKorpu = function () {
    ...
    KorpaComponent.prototype.brojStavki = function () {
        return this.korpa.length;
    };
    KorpaComponent.prototype.izvrsiKupovinu = function () {
        var _this = this;
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.value) {
                swalWithBootstrapButtons.fire('Uspesno ste izvrsili kupovinu!', 'Ocekujte porudzbinu u naredna 3 radna dana.', 'success'),
                    _this.korpa = _this.shoppingservice.ocistiKorpu();
    ...
    KorpaComponent.ctorParameters = function () { return [
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(autentifikacijaService, router) {
        this.autentifikacijaService = autentifikacijaService;
        this.router = router;
    ...
    NavbarComponent.prototype.odjaviSe = function () {
        this.autentifikacijaService.odjaviSe();
        this.router.navigate(['/signin']);
...
var OpisProizvodaComponent = /** @class */ (function () {
    function OpisProizvodaComponent(route, shoppingService, autentifikacijaService, router) {
        this.route = route;
        this.shoppingService = shoppingService;
        this.autentifikacijaService = autentifikacijaService;
        this.router = router;
    ...
    OpisProizvodaComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
var PhotoGalleryComponent = /** @class */ (function () {
    function PhotoGalleryComponent(_router) {
        this._router = _router;
    }
    PhotoGalleryComponent.prototype.goGallery = function () {
...
var PostblogService = /** @class */ (function () {
    function PostblogService() {
        this.bloglist = _bloglist__WEBPACK_IMPORTED_MODULE_2__["bloglist"];
        this.bloglistkorpa = [];
    }
    PostblogService.prototype.dodajUBlogKorpu = function (blog) {
        this.bloglistkorpa.push(blog);
    };
    PostblogService.prototype.uzmiBlog = function () {
        return this.bloglistkorpa;
    };
    PostblogService.prototype.ocistiBlogKorpu = function () {
        this.bloglistkorpa = [];
        return this.bloglistkorpa;
    };
...
var ServeriService = /** @class */ (function () {
    function ServeriService(httpClient, autentifikacijaService) {
        this.httpClient = httpClient;
        this.autentifikacijaService = autentifikacijaService;
    }
    ServeriService.prototype.vratiServere = function () {
        var token = this.autentifikacijaService.vratiToken();
        return this.httpClient.get('https://tefal-shop.firebaseio.com/data.json?auth=' + token);
    };
    ServeriService.prototype.skladistiServere = function (serveri) {
        var token = this.autentifikacijaService.vratiToken();
        return this.httpClient.put('https://tefal-shop.firebaseio.com/data.json?auth=' + token, serveri);
    };
    ServeriService.ctorParameters = function () { return [
...
var ShopComponent = /** @class */ (function () {
    function ShopComponent(shoppingService, autentifikacijaService, router) {
        this.shoppingService = shoppingService;
        this.autentifikacijaService = autentifikacijaService;
        this.router = router;
    ...
    ShopComponent.prototype.staviUKorpu = function (proizvod) {
        this.shoppingService.dodajUKorpu(proizvod);
...
var TefalshopPocetnaComponent = /** @class */ (function () {
    function TefalshopPocetnaComponent() {
        this.appName = 'Tefal Shop';
    }
    TefalshopPocetnaComponent.prototype.ngOnInit = function () {
    };
    ...
    return TefalshopPocetnaComponent;
}());
...
var VideofileComponent = /** @class */ (function () {
    function VideofileComponent() {
    }
    VideofileComponent.prototype.ngOnInit = function () {
    };
...
var ZastitaService = /** @class */ (function () {
    function ZastitaService(autentifikacijaService) {
        this.autentifikacijaService = autentifikacijaService;
    }
    ZastitaService.prototype.canActivate = function (route, state) {
        return this.autentifikacijaService.prijavljen();
    };
    ZastitaService.ctorParameters = function () { return [
        { type: _autentifikacija_service__WEBPACK_IMPORTED_MODULE_2__["AutentifikacijaService"] }
    ]; };
    ZastitaService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
    ], ZastitaService);
    return ZastitaService;
}());
